...
if True:
    ...
    BASE_LVDS_CONFIG = f'{Path(__file__).parent}/dca1000/lvds_config.json'
    BASE_LVDS_BINARY = f'{Path(__file__).parent}/dca1000/DCA1000EVM_CLI_Control'
...
BASE_CONFIG = f'{Path(__file__).parent}/dca1000/f30_v3.cfg'
