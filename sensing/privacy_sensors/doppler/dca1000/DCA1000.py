...
class DCA1000:
    ...
    def __init__(self, static_ip='192.168.33.30', adc_ip='192.168.33.180',
                 data_port=4098, config_port=4096, adc_params=None, ):
        # Save network data
        ...
        # DYNAMIC
        self.BYTES_IN_FRAME = (self.ADC_PARAMS['chirps'] * self.ADC_PARAMS['rx'] * self.ADC_PARAMS['tx'] *
                          self.ADC_PARAMS['IQ'] * self.ADC_PARAMS['samples'] * self.ADC_PARAMS['bytes'])
        self.BYTES_IN_FRAME_CLIPPED = (self.BYTES_IN_FRAME // self.BYTES_IN_PACKET) * self.BYTES_IN_PACKET
        self.PACKETS_IN_FRAME = self.BYTES_IN_FRAME / self.BYTES_IN_PACKET
        self.PACKETS_IN_FRAME_CLIPPED = self.BYTES_IN_FRAME // self.BYTES_IN_PACKET
    ...
    def _send_command(self, cmd, length='0000', body='', timeout=1):
        ...
        try:
            ...
            resp, addr = self.config_socket.recvfrom(self.MAX_PACKET_SIZE)
    ...
    def _listen_for_error(self):
        ...
        msg = self.config_socket.recvfrom(self.MAX_PACKET_SIZE)
