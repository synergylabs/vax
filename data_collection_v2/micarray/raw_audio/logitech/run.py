...
sys.path.append(f"/home/vax/vax-rpi/")
import os
...
if __name__ == '__main__':
    ...
    # initialize logger
    logger = get_logger('respeaker_audio_recorder', '/home/vax/cache/logs/audio/')
    logger.info("------------ New Respeaker Recording Run ------------")
    ...
    device_id, num_channels, sampling_rate = get_device_info()
    # sys.exit(0)
    # get audio filename
