"""
This file contains preprocessing logic for lidar2d file
"""
import os.path
...
lidar2d_files = glob.glob(f"/Volumes/Vax Storage/{collectionfolder}/{user}/*/rplidar_*.csv")
