...
if __name__ == '__main__':
    ...
    BASE_SRC_DIR = '/Users/ppatida2/VAX/vax-public/generate_timestamped_av_labels'
    RAW_DATA_DIR = '/Users/ppatida2/VAX/vax-public/cache/nas_cache/phase15_study/instance_av_data'
    OTC_CACHE_DIR = '/Users/ppatida2/VAX/vax-public/cache/otc_15'
    POSE_CACHE_DIR = '/Users/ppatida2/VAX/vax-public/cache/nas_cache/phase15_study/pose_cache'
    ENSEMBLE_DIR = '/Users/ppatida2/VAX/vax-public/cache/av_ensemble_models'
    PROCESSED_INSTANCE_DIR = '/Users/ppatida2/VAX/vax-public/cache/nas_cache/phase15_study/processed_data'
    USER = 'PHU8'
    ...
    run_config = {
        ...
        'num_training_days':2,
        'run_context': 'Kitchen',
        'otc_cache_dir':f'{OTC_CACHE_DIR}/{USER}',
        'pose_cache_dir':f'{POSE_CACHE_DIR}/{USER}',
        'data_dir':f'{RAW_DATA_DIR}/{USER}',
        'av_ensemble_file': f'{ENSEMBLE_DIR}/{USER}.pb',
        'cache_dir': f'{BASE_SRC_DIR}/cache/phase15_e2e/{USER}',
        'processed_data_dir': f'{PROCESSED_INSTANCE_DIR}/{USER}',
